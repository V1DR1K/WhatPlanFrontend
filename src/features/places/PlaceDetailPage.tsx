  ...
  return <section className="detail">
    ...
    <div className="detail-heading">
      ...
      <div className="detail-actions">
        ...
        {ownVenue && <button className="text-button food-detail-delete" type="button" disabled={archive.isPending} onClick={() => setConfirmingArchive(true)}>{archive.isPending ? "Borrando…" : "Borrar lugar"}</button>}
      </div>
    </div>
